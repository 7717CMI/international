...
export function generateInsights(
  ...
  volumeUnit: string = 'Number of Moves'
): Insight[] {
 ...
 */
function findTopPerformer(records: DataRecord[], filters: FilterState, currency: 'USD' | 'INR' = 'USD', volumeUnit: string = 'Number of Moves'): Insight | null {
